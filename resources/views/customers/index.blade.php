    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="col-lg-2 p-0 mb-2">
                <a href="{{ route('customers.create') }}" class="btn btn-primary btn-block">Create Customer</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($customers as $customer)
                            <tr>
                                ...
                                <td>{{ $customer->fleet }}</td>
                                <td>{{ $customer->monthly }}</td>
                                <td>
                                    <a href="{{ route('customers.edit', $customer->customer_id) }}" class="badge bg-warning"
                                        title="Update">
