                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                            placeholder="Masukkan nama supplier" value="{{ old('nama', $supplier->name) }}" required>
                        @error('nama')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="kontak_person"
                            ...
                            value="{{ old('kontak_person', $supplier->contact_person) }}" required>
                        @error('kontak_person')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="telepon" class="form-control @error('telepon') is-invalid @enderror"
                            placeholder="08xxxxxxxxxx atau 628xxxxxxxxx" value="{{ old('telepon', $supplier->phone) }}"
                            required>
                        @error('telepon')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3"
                            placeholder="Masukkan alamat lengkap" required>{{ old('alamat', $supplier->address) }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
