...
@section('contents')
    <div class="card mb-4">
        <div class="card-header"><strong>Mekanik List</strong></div>
        <div class="card-body">
            @if (session('success'))
            ...
            <div class="col-lg-2 p-0 mb-2">
                <a href="{{ route('mechanics.create') }}" class="btn btn-primary btn-block">Create Mekanik</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($mechanics as $mechanic)
                            <tr>
                                ...
                                <td>{{ $mechanic->name }}</td>
                                <td>{{ \Carbon\Carbon::parse($mechanic->dob)->format('d F Y') }}</td>
                                <td>{{ \Carbon\Carbon::parse($mechanic->join_date)->format('d F Y') }}</td>
                                ...
                                <td>
                                    <a href="{{ route('mechanics.edit', $mechanic->mechanic_id) }}" class="badge bg-warning"
                                        title="Update">
                                    ...
                                    <form action="{{ route('mechanics.destroy', $mechanic->mechanic_id) }}" method="POST"
                                        class="d-inline">
                                        @method('delete')
                                        @csrf
